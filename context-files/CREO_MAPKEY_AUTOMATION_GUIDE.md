...
A comprehensive template script ([TEMPLATE.PS1](../docs/TEMPLATE.PS1)) is available in this repository to serve as the foundation for all new Creo automation scripts. This template incorporates all best practices, common patterns, and the 4-phase architecture documented in this guide.
...
1. **Copy the Template**:
   ...
   Copy-Item "docs\TEMPLATE.PS1" "your_automation_name.ps1"
   ```
...
[TEMPLATE.PS1](../docs/TEMPLATE.PS1) - Located in the `docs/` folder of this repository

#### **Quick Start Example**
```powershell
# 1. Copy template to new script
Copy-Item "docs\TEMPLATE.PS1" "chamferator.ps1"
...
**Key Resources**:
- **[TEMPLATE.PS1](../docs/TEMPLATE.PS1)**: Comprehensive starting point for all new automation scripts
