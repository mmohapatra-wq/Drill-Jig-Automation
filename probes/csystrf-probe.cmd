...
Write-Host "  ============================================================" -ForegroundColor Cyan
$recipeFile = Join-Path $ScriptDir 'artifacts\csystrf_recipe.txt'
$recipeDir = Split-Path -Parent $recipeFile; if ($recipeDir -and -not (Test-Path $recipeDir)) { New-Item -ItemType Directory -Force -Path $recipeDir | Out-Null }
$captured = @()
if ($null -ne $trail) {
